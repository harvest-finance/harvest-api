...
const getPoolApy = async (poolId, reduction) => {
  ...
  const tokenInstance = new web3.eth.Contract(abi, poolInfo.stakingToken)
  const totalSupply = new BigNumber(poolInfo.stakingTokenTotalAmount).dividedBy(new BigNumber(10).exponentiatedBy(18))
