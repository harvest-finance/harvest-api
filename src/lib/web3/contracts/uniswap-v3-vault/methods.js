...
const getCurrentRangePositionId = instance => countFunctionCall(instance.methods.getCurrentRangePositionId().call())

module.exports = { getCap, getDepositCapReached, getWithdrawalTimestamp, getCurrentCap, getPositionIds, getCurrentRangePositionId }