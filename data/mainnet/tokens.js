...
module.exports = {
  ...
  bFARMBoost: {
    ...
    tokenAddress: addresses.BSC.bFARM,
    displayName: 'bFARM',
    amplifierViewerAddress: addresses.BSC.V2.AmpliFARM.amplifierViewer,
    amplifierTokenAddress: addresses.BSC.V2.AmpliFARM.tokenAddress,
    amplifierContractAddress: addresses.BSC.V2.AmpliFARM.amplifier,
    amplifierTokenDisplayName: 'ampliFARM',
    amplifierTokenLogoUrl: './icons/amplifarm.png',
    proxyAddress: addresses.BSC.V2.AmpliFARM.proxy,
    decimals: '18',
    priceFunction: { type: GET_PRICE_TYPES.COINGECKO_CONTRACT, params: [addresses.FARM] },
  },
  FCASH: {
