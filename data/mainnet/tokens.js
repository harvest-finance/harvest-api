...
module.exports = {
  ...
  notional_ETH: {
    ...
    priceFunction: {
      type: GET_PRICE_TYPES.NOTIONAL,
      params: [2, addresses.V2.notional_ETH.Underlying, addresses.ETH],
    },
    estimateApyFunctions: [
      {
        type: ESTIMATED_APY_TYPES.NOTIONAL,
        params: [2, addresses.NOTE, addresses.V2.notional_ETH.Underlying, addresses.ETH, '0.7'],
      },
    ],
    cmcRewardTokenSymbols: ['iFARM', 'NOTE'],
  },
  notional_USDC: {
    ...
    priceFunction: {
      type: GET_PRICE_TYPES.NOTIONAL,
      params: [2, addresses.V2.notional_USDC.Underlying, addresses.USDC],
    },
    estimateApyFunctions: [
      {
        type: ESTIMATED_APY_TYPES.NOTIONAL,
        params: [2, addresses.NOTE, addresses.V2.notional_USDC.Underlying, addresses.USDC, '0.7'],
      },
    ],
    cmcRewardTokenSymbols: ['iFARM', 'NOTE'],
  },
  notional_WBTC: {
    ...
    priceFunction: {
      type: GET_PRICE_TYPES.NOTIONAL,
      params: [2, addresses.V2.notional_WBTC.Underlying, addresses.WBTC],
    },
    estimateApyFunctions: [
      {
        type: ESTIMATED_APY_TYPES.NOTIONAL,
        params: [2, addresses.NOTE, addresses.V2.notional_WBTC.Underlying, addresses.WBTC, '0.7'],
      },
    ],
    cmcRewardTokenSymbols: ['iFARM', 'NOTE'],
  },
  ...
  jarvis_2NZD_HODL: {
    ...
    apyDescriptionOverride: [
      'Auto harvested <b>JRT(JUL22)</b> deposited into <b>JRT(JUL22)-USDC</b> for more APY',
    ],
  ...
  jarvis_2EUR_HODL: {
    category: VAULT_CATEGORIES_IDS.JARVIS,
    chain: CHAINS_ID.MATIC_MAINNET,
    logoUrl: './icons/2eur.png',
    apyIconUrls: ['./icons/den.png'],
    apyTokenSymbols: ['agDEN-JUL22'],
    displayName: 'Jarvis: 2EUR',
    subLabel: 'HODL',
    ...
    apyDescriptionOverride: [
      'Auto harvested <b>agDEN(JUL22)</b> deposited into <b>agDEN(JUL22)-2EUR</b> for more APY',
    ],
