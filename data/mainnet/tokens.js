...
module.exports = {
  ...
  bal_TUSD_STABLE: {
    ...
    apyIconUrls: ['./icons/balancer.png', './icons/wmatic.png', './icons/tusd.png'],
    apyTokenSymbols: ['BAL', 'WMATIC', 'TUSD'],
    ...
    estimateApyFunctions: [
      {
        ...
        params: [
          ...
          CHAINS_ID.MATIC_MAINNET,
          [addresses.MATIC.WMATIC, addresses.MATIC.pTUSD],
          ['27500', '55000'],
        ],
      },
    ],
  ...
  UniV3_ETH_sETH2: {
    ...
    apyIconUrls: ['./icons/univ3.png', './icons/reth2.png'],
    apyTokenSymbols: ['UNI', 'rETH2'],
    ...
    pricesInfo: {
      ETH: ['Min price: 1.000 sETH2 per ETH', 'Max price: 1.006 sETH2 per ETH'],
      sETH2: ['Min price: 0.99402 ETH per sETH2', 'Max price: 1.000 ETH per sETH2'],
    },
    priceFunction: {
      type: GET_PRICE_TYPES.LP_TOKEN,
